...
public class OFF.Structures.PDFSource : GLib.Object {
    ...
    public static Cairo.ImageSurface pdf_surface;
    ...
    private Gdk.Pixbuf create_pixbuf_from_pdf (Poppler.Page pdf_page) {
        ...
        pdf_surface = new Cairo.ImageSurface (Cairo.Format.RGB24, (int) width, (int) height);
        pdf_context = new Cairo.Context (pdf_surface);
        
        pdf_context.set_source_rgba (1,1,1,1);
        pdf_context.paint ();
