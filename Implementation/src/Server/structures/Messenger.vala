...
public abstract class OFF.Structures.Messenger : GLib.Object {
    ...
    protected uint8 red = 0;
    protected uint8 green = 0; 
    protected uint8 blue = 0;
    protected uint8 last_red = 0;
    protected uint8 last_green = 0;
    protected uint8 last_blue = 0;
    ...
    public void next_color_message () {
        ...
        while (is_same_color) {
            ...
            if (last_red != red || last_green != green || last_blue != blue) {
...
//        message ("Color Mesage: %d,%d,%d,%d", red, green, blue, pixels);
        _color_message = new ColorMessage (red, green, blue, pixels);
        this.send_message (_color_message);
        message (("Color Message:\t\t\t\t" + _color_message.generate_message ()).printf ());
